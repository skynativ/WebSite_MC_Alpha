<div style="margin-top:20px;" class="container">
    <div class="row">
        <div class="col-md-6 col-md-push-3">
            <div class="product text-center" style="padding:15px">
                <form method="post" data-redirect-url="?" data-ajax="true" action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_register')) ?>">
                    ...
                    <h1 style="margin-bottom:30px;font-family: Oswald,sans-serif;font-weight: 900;color: #c0392b;text-align: center;"><?= $Lang->get('USER__REGISTER') ?></h1>
                    ...
                    <?php if (!empty($condition)) { ?>
                        <div class="form-group">
                            <div class="checkbox" style="font-family: Oswald,sans-serif;font-weight: 900;color: #c0392b;text-align: center;">
                                <label> 

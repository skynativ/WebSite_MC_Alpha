    		...
    		<div class="ribbon-content"><p>
    			...
    			<?php } ?>
			     <?php if($isConnected AND $Permissions->can('CREDIT_ACCOUNT')) { ?>
      			<a href="#" data-toggle="modal" data-target="#addmoney" class="btn btn-primary pull-right" style="margin-top:-4px"><?= $Lang->get('SHOP__ADD_MONEY') ?></a>
                ...
                foreach ($search_items as $key => $value) { ?>
                  ...
                  ?>
                      ...
                      <div class="thumbnail">
                      	...
                      	<div class="caption">
                          	<?php if(isset($value['Item']['img_url'])) { ?><img src="<?= $value['Item']['img_url'] ?>" width="100px" style="height:auto" alt=""><?php } ?>
                          </div>

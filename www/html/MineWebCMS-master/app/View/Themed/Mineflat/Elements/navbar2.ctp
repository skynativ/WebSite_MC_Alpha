        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
							...
							<?php } else { ?>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                       aria-expanded="false"><?= $value['Navbar']['name'] ?> <span
                                                class="caret justi"></span></a>
                ...
                <li class="li-nav">
                    <div class="btn-group">
						<?php if ($isConnected) { ?>
                            <a style="padding-top:6px;color:#fff;float: left;"
                               href="<?= $this->Html->url(array('controller' => 'profile', 'action' => 'index', 'plugin' => null)) ?>"
                               class="user-btn"><?= $user['pseudo'] ?></a>
						<?php } else { ?>
                            <a style="padding-top:6px;color:#fff;float: left;" href="#login" href="#"
                               data-toggle="modal" data-target="#login" class="user-btn"><i class="fa fa-user"></i></a>
						<?php } ?>
                        <button type="button" class="btn arrow-btn dropdown-toggle" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
							...
							<?php } else { ?>
                                <a class="btn btn-profile btn-block" href="#" data-toggle="modal"

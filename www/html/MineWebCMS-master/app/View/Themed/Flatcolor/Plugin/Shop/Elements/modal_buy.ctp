...
<div class="pull-left">
  <button class="btn btn-success disabled">{LANG-SHOP__ITEM_TOTAL} : <span id="total-price">{ITEM_PRICE}</span>  {SITE_MONEY}</button>
</div>
[IF MULTIPLE_BUY]
  <div class="col-md-3">
...
[/IF MULTIPLE_BUY]
[IF ADD_TO_CART]
  <button type="button" class="btn btn-info add-to-cart" data-item-id="{ITEM_ID}" id="btn-cart">{LANG-SHOP__BUY_ADD_TO_CART}</button>
[/IF ADD_TO_CART]

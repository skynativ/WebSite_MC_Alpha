    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row form-group">
                <div class="col-xs-12">
                    <ul class="nav nav-pills nav-justified well setup-panel">
                        <li class="active">
                            <a href="#step-1">
                    ...
                    <div class="col-md-12 well setup-content text-center">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            <div style="width: 100%;display: inline-block;">
                                ...
                                <input style="text-align: center;" type="text" class="form-control" name="username" <?= ($user) ? 'value="' . $user['pseudo'] . '" disabled' : '' ?>>
                            </div>
                            <br>
                            ...
                            foreach ($websitesByServers as $serverName => $websites) {
                                ...
                                echo '<div class="col-md-4">';
                                    echo '<div class="panel panel-default">';
                                        echo '<div class="panel-heading text-center" style="background: #40A8F7">';
                                            echo '<h3 class="panel-title" style="color: #ffffff" ><strong>' . $serverName . '</strong></h3>';
                                        echo '</div>';
                    ...
                    <div class="col-md-12 well setup-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <a type="submit" class="btn btn-success btn-block get-reward" Onclick="setTimeout('history.go(0);',1000);" data-reward="now"><?= $Lang->get('VOTE__GET_REWARD_NOW') ?></a>
                                <a type="submit" class="btn btn-success btn-block get-reward" Onclick="setTimeout('history.go(0);',1000);" data-reward="later"><?= $Lang->get('VOTE__GET_REWARD_LATER') ?></a>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <?php
								...
								++$i;
									...
									echo "<td>#$i";
								if ($i === 1)
									echo '&nbsp;<i style="color:rgb(222, 190, 21); font-weight:bold;" class="fa fa-trophy"> '.$theme_config['top_1'].'</i>';
								else if ($i === 2)
									echo '&nbsp;<i style="color:rgb(192, 192, 192); font-weight:bold;" class="fa fa-trophy"> '.$theme_config['top_2'].'</i>';
								else if ($i === 3)
									echo '&nbsp;<i style="color:rgb(162, 63, 7); font-weight:bold;" class="fa fa-trophy"> '.$theme_config['top_3'].'</i>';
								echo "</td>";
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div style="background-color: #40A8F7" class="alert alert-info"><?= $Lang->get('VOTE__MODAL_DESC') ?></div>
                <a href="#" id="voteBtn" target="_blank" onclick="$('#redirectModal').modal('hide');startTimerCheckVote()" class="btn btn-primary btn-block"><?= $Lang->get('VOTE__MODAL_BTN') ?></a>
            </div>
        </div>
    </div>
</div>
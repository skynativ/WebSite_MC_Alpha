    ...
    <div class="row page">
        <div class="col-md-12">
            ...
            <div class="row form-group">
                <div class="col-xs-12">
                    <ul class="nav nav-pills nav-justified thumbnail setup-panel page-content">
                        <li class="active">
                            <a href="#step-1">
            ...
            <div class="row step active" id="step-1">
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content text-center page-content">
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            ...
                            <br><br>
                            <button class="btn btn-primary" type="submit">Passer a l'étape suivante</button>
                        </form>
            ...
            <div class="row step" id="step-2">
                <div class="col-xs-12">
                    <div class="col-md-12 well setup-content page-content">
                        <div class="loader">
                            <p>
                        ...
                        <div class="row">
                            ...
                            foreach ($websitesByServers as $serverName => $websites) {
                                ...
                                foreach ($websites as $website) {
                                    echo '<a data-website-id="' . $website['Website']['id'] . '" href="' . $website['Website']['url'] . '" target="_blank" class="btn btn-block btn-primary website">' . $website['Website']['name'] . '</a>';
                                }
                                echo '</div>';
                                echo '</div>';
                                echo '</div>';
                    ...
                    <div class="col-md-12 well setup-content page-content">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <button class="btn btn-primary btn-block get-reward" data-reward="now"><?= $Lang->get('VOTE__GET_REWARD_NOW') ?></button>
                                <button class="btn btn-primary btn-block get-reward" data-reward="later"><?= $Lang->get('VOTE__GET_REWARD_LATER') ?></button>
                            </div>
                        </div>
...
<style>
    ...
    .page-content.nav li.disabled p {
        color: #656363;
    }
...
<script type="text/javascript">
    ...
    function next(step)
    {
        ...
        $('a[href="#step-' + (step - 1).toString() + '"]').parent().removeClass('active').addClass('disabled')

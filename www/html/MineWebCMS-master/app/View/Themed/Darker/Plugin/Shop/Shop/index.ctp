      ...
      <div class="col-sm-3">
          ...
          <div class="panel-body">
            ...
            ?>
              ...
              <?php if($isConnected AND $Permissions->can('CREDIT_ACCOUNT')) { ?>
                    <a href="#" data-toggle="modal" data-target="#addmoney" class="theme-color-btn block" style="margin-top:20px;"><?= $Lang->get('SHOP__ADD_MONEY') ?></a>
            <?php } ?>
        ...
        <div class="panel panel-default sidebar-menu">
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <?php if($isConnected) { ?>
                  <a href="#" data-toggle="modal" data-target="#cart-modal" class="theme-color-btn block"><?= $Lang->get('SHOP__BUY_CART') ?></a>
                <?php } ?>
              </div> 
            </div>
          <?php } ?>
                ...
                echo '<div class="product">';
                  ...
                  echo '<div class="text">';
                    ...
                    echo '<p class="buttons">';
                      echo '<a href="#" class="theme-color-btn block display-item" data-item-id="'.$item['id'].'">'.$Lang->get('SHOP__BUY').'</a>';
                    echo '</p>';
                  echo '</div>';

            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form action="<?= $this->Html->url(array('action' => 'add_voucher_ajax', 'admin' => true)) ?>"
                          ...
                          data-redirect-url="<?= $this->Html->url(array('controller' => 'shop', 'action' => 'vouchers')) ?>">
                  ...
                  <button class="btn btn-info" type="button"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control"
                                   placeholder="<?= $Lang->get('SHOP__VOUCHER_VALUE_INPUT', array('{MONEY_NAME}' => $Configuration->getMoneyName())) ?>"
                                   type="text" name="reduction">
                            <small>Ex: 10</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="limit_type">
                                <option value="1"><?= $Lang->get('SHOP__VOUCHER_LIMIT_TYPE_USER') ?></option>
                                <option value="2"><?= $Lang->get('SHOP__VOUCHER_LIMIT_TYPE_GLOBAL') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                ...
                                <br>
                                <small><?= $Lang->get('SHOP__VOUCHER_DISPLAY_CHECKBOX') ?></small>
                            </div>
                        </div>

                        <div class="pull-right">
                            <a href="<?= $this->Html->url(array('controller' => 'shop', 'action' => 'index', 'admin' => true, 'plugin' => 'shop')) ?>"
